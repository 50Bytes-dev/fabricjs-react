...
const V = "#000000", ae = "rgba(255, 255, 255, 0.0)", mr = {
  ...
  } = i, [p, T] = K(null), [a, c] = K(y || ae), [f, S] = K(m || V), [g, _] = K([]);
  Ie(() => {
    p && ((k) => {
  ...
  const w = yr(() => p ? _r(p, a, f, c, S, h) : void 0, [p]);
  return {
    selectedObjects: g,
    onReady: (j) => {
...
function Tr() {
  ...
  function a(c, f, S) {
    ...
    S !== void 0 && (w = "" + S), f.key !== void 0 && (w = "" + f.key), f.ref !== void 0 && (j = f.ref);
    for (g in f)
      m.call(f, g) && !T.hasOwnProperty(g) && (_[g] = f[g]);
    if (c && c.defaultProps)
      for (g in f = c.defaultProps, f)
        _[g] === void 0 && (_[g] = f[g]);
    return { $$typeof: h, type: c, key: w, ref: j, props: _, _owner: p.current };
  }
...
function Or() {
  return Ae || (Ae = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function ze(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === T || Ue || e === p || e === S || e === g || Ve || e === j || Ye || Me || Ne || typeof e == "object" && e !== null && (e.$$typeof === w || e.$$typeof === _ || e.$$typeof === a || e.$$typeof === c || e.$$typeof === f || e.$$typeof === oe || e.getModuleId !== void 0));
    }
    function Je(e, r, t) {
      var n = e.displayName;
      if (n)
    ...
    function Se(e, r) {
      {
        ...
        Oe[t] = !0;
        var n = "";
        e && e._owner && e._owner !== Q.current && (n = " It was passed a child from " + C(e._owner.type) + "."), F(e), b('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', t, n), F(null);
      }
    }
    function Ce(e, r) {
      {
    ...
    function je(e, r, t, n, u, l) {
      {
        ...
        if (!s) {
          ...
          E ? o += E : o += Te();
          var d;
          e === null ? d = "null" : H(e) ? d = "array" : e !== void 0 && e.$$typeof === h ? (d = "<" + (C(e.type) || "Unknown") + " />", o = " Did you accidentally export a JSX literal instead of a component?") : d = typeof e, b("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", d, o);
        }
        var v = ur(e, r, t, u, l);
        if (v == null)
          return v;
        ...
        if (W.call(r, "key")) {
          var x = C(e), R = Object.keys(r).filter(function(hr) {
            return hr !== "key";
...
const Fe = Le.exports.jsx, wr = ({
  ...
  return Ie(() => {
    var c;
    const p = new N.Canvas((c = y.current) != null ? c : void 0), T = () => {
      var f, S;
      p.setHeight(((f = m.current) == null ? void 0 : f.clientHeight) || 0), p.setWidth(((S = m.current) == null ? void 0 : S.clientWidth) || 0), p.renderAll();
    }, a = () => {
      T();
    };
...
export {
  wr as FabricJSCanvas,
  Cr as useFabricJSEditor
};
